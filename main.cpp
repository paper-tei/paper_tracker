...
int main()
{
    ...
    auto version = updater.getClientVersion();
    if (version.has_value())
    {
        std::cout << version.value().version.description << std::endl;
        std::cout << version.value().version.tag << std::endl;
        std::cout << version.value().version.firmware << std::endl;
    }

    updater.downloadAppToLocal();

    auto local_version = updater.getCurrentVersion();
    if (local_version.has_value())
    {
        std::cout << local_version.value().version.description << std::endl;
        std::cout << local_version.value().version.tag << std::endl;
        std::cout << local_version.value().version.firmware << std::endl;
    }
